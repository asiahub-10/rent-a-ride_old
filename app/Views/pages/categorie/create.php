		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12 mt-5">
					<h3 class="page-title mt-3">Create Categorie</h3>
					<ul class="breadcrumb">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form-horizontal" action="<?php echo base_url(); ?>/category/save" enctype="multipart/form-data" method="post">
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="txtPassengerCapacity" />
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-2 col-form-label">Luggage capacity</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="txtLuggageCapacity" />
							</div>
						</div>
					</div>
