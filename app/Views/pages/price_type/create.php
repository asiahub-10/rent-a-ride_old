		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12 mt-5">
					<h3 class="page-title mt-3">Create Price Type</h3>
					<ul class="breadcrumb">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form-horizontal" action="<?php echo base_url(); ?>/PriceType/save" enctype="multipart/form-data" method="post">
					<div class="card-body">
